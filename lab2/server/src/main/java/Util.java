...
public class Util {
    ...
    public static NtpPacket pack(NtpPacket clientRequest, long timeOfReceipt, byte[] hostAddress) {
        ...
        //hostAddress to int
        int serverAddres = convertBytesToInteger(0, 3, hostAddress);
        ...
        serverResponse.setPrecision((byte) -23);
        serverResponse.setRootDelay(0);
        serverResponse.setRootDispersion(0);
        serverResponse.setReferenceIdentifier(serverAddres);
